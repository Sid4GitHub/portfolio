...
const Hero = () => {
    ...
    const three = <h3 style={{ color: 'var(--text-secondary)', fontSize: 'clamp(30px, 6vw, 60px)', lineHeight: 1.1, marginTop: '10px' }}>I build the foundational platforms for data.</h3>;
    const four = (
